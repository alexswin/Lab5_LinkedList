...
class LinkedList : public LinkedListInterface<T> {
	...
	public:
		...
		*/
		void insertTail(T value) {
			...
			if (numItems == 0) {
				head = new Node(value);
				++numItems;
				//cout << "Empty list. Head is now " << head->data << ". ";
			}
		...
		*/
		void insertAfter(T value, T insertionNode) {
			...
			if (afterMe == NULL) {
				...
				/*cout << value << " is not a duplicate. Proceeding with insert. Current order: " << afterMe->data << ", ";
				if (afterMe->next == NULL) {cout << "null" << endl;}
				else {cout << afterMe->next->data << endl;}*/
			...
			//else {cout << value << " already present. Cannot insert. Returning..." << endl;}
		};
		...
		*/
		string toString() {
			//cout << "In toString. Parsing list..." << endl;
